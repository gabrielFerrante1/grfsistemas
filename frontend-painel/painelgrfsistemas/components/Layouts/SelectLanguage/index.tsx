            ...
            <Dropdown.Item>
                {i18n.language != 'pt' ?
                    <div onClick={()=>setLanguage('pt')}>
                        <img style={{width:30,height:30,display:'inline'}} src="/imgs/brasil.png" />
                        <span style={{fontSize:13}}>Portugûes</span>
                    </div>
                :
                    <div onClick={()=>setLanguage('en')}>
                        <img style={{width:20,height:20,marginRight:5,display:'inline'}}  src="/imgs/estados-unidos-da-america.png" />
